...
import org.glycoinfo.batch.wurcs.subsumption.composition.app.CompositionConverter;
...
@SpringApplicationConfiguration(classes = { CompositionConverterTest.class, VirtSesameTransactionConfig.class, GlycanProcedureConfig.class, GlyConvertConfig.class })
@Configuration
@EnableAutoConfiguration
@IntegrationTest
public class CompositionConverterTest {

  private static final Log logger = LogFactory.getLog(CompositionConverterTest.class);
