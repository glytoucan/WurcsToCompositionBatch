package org.glycoinfo.batch.wurcs.subsumption.composition;
...
import org.glycoinfo.batch.wurcs.subsumption.composition.app.Config;
import org.glycoinfo.batch.wurcs.subsumption.composition.app.JobConfig;
import org.glycoinfo.batch.wurcs.subsumption.composition.app.ProcessorConfig;
import org.glycoinfo.batch.wurcs.subsumption.composition.app.WurcsCompositionSparqlBatch;
...
@SpringApplicationConfiguration(classes = { WurcsCompositionSparqlBatchTest.class, Config.class, VirtSesameTransactionConfig.class, GlyConvertConfig.class, ProcessorConfig.class})
//@SpringApplicationConfiguration(classes = { WurcsTopologySparqlBatch.class })
@IntegrationTest
@EnableAutoConfiguration
public class WurcsCompositionSparqlBatchTest {
...
//    String output = glycanProcedure.register("WURCS=2.0/7,9,8/[a2122h-1b_1-5_2*NCC/3=O][a1122h-1b_1-5][a1122h-1a_1-5][a221h-1x_1-5][a2112h-1x_1-5][a1221m-1x_1-5][a1221m-1a_1-5]/1-1-2-3-4-5-3-6-7/a4-b1_a6-i1_b4-c1_c3-d1_c6-g1_d?-e1_e?-f1_g?-h1", "254");
    ...
    String id1 = processed.getValue(MonosaccharideCompositionInsertSparql.PrimaryId_1);
    String id2 = processed.getValue(MonosaccharideCompositionInsertSparql.PrimaryId_2);
...
//    confirm the filter works by running it again.
  ...
  @Test
  @Transactional
  public void testG00093PP() throws Exception {
    SparqlEntity onewurcs = new SparqlEntity();
    
    onewurcs.setValue(Saccharide.PrimaryId, "G88203PI");
    onewurcs.setValue(ConvertSelectSparql.Sequence, "WURCS=2.0/5,5,4/[h2112h_2*NCC/3=O][a2122h-1x_1-?_3-6_2*NCC/3=O][a2112h-1x_1-5_2*NCC/3=O_4*OSO/3=O/3=O][a2112h-1x_1-5][a1221m-1x_1-5]/1-2-3-4-5/a?-b1_a?-d1_b?-c1_d?-e1");
  ...
  @Test
  @Transactional
  public void testG00002CF() throws Exception {
    SparqlEntity onewurcs = new SparqlEntity();
    
    onewurcs.setValue(Saccharide.PrimaryId, "G00002CF");
    onewurcs.setValue(ConvertSelectSparql.Sequence, "WURCS=2.0/3,4,3/[a2122h-1x_1-5][a2112h-1x_1-5][Aad21122h-2x_2-6_5*NCCO/3=O]/1-2-3-3/a?-b1_b?-c2_c?-d2");
  ...
  @Test
  @Transactional
  public void testG15520IM() throws Exception {
    SparqlEntity onewurcs = new SparqlEntity();
    
    onewurcs.setValue(Saccharide.PrimaryId, "G15520IM");
    onewurcs.setValue(ConvertSelectSparql.Sequence, "WURCS=2.0/2,2,1/[a2122h-1x_1-5][a2122h-1x_1-5_3-6]/1-2/a?-b1");
