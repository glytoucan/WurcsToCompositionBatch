...
public class CompositionConverter implements SparqlEntityConverter<SparqlEntity> {
  private static final Log logger = LogFactory.getLog(CompositionConverter.class);
  ...
  public SparqlEntity convert(SparqlEntity e) throws SparqlException {
    ...
    e.setValue(MonosaccharideCompositionInsertSparql.PrimaryId_1, e.getValue(Saccharide.PrimaryId));

    // topology acc num => PrimaryId_2
    e.setValue(MonosaccharideCompositionInsertSparql.PrimaryId_2, topAccessionNumber);
